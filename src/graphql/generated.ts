...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, availableAt?: any | null, title: string, lessonType: LessonType, slug: string }> };
